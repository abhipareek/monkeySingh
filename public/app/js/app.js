...
; (function ($) {
    ...
    var retinaLogos = function() {
        var retina = window.devicePixelRatio > 1 ? true : false;
          if(retina) {
              $('.header__logo').find('img').attr( {src:'/static/assets/images/logo/mlogo.png',width:'200',height:'30'} );
              $('.logo_footer').find('img').attr( {src:'/static/assets/images/logo/mlogo.png',width:'230',height:'44'} );
            }   
      };
